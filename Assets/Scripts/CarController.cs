...
public class CarController : MonoBehaviour
{
    ...
    //GeneticManager manager = new GeneticManager();
    ...
    private void FixedUpdate() {
        ...
        if(Input.GetKeyDown(KeyCode.P)) {
            if(GameObject.FindObjectOfType<GeneticManager>().saving == false) {
                GameObject.FindObjectOfType<GeneticManager>().saving = true;
                GameObject.FindObjectOfType<GeneticManager>().SavePopulationToFile();
            }
        }
    ...
    private void Death ()
    {
        //manager.Death(overallFitness, network);
