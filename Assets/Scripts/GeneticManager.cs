...
public class GeneticManager : MonoBehaviour
{
    ...
    private void CreatePopulation()
    {
        ...
        /*for(int i=0; i<initialPopulation; i++) {
            //NNet nnet = gameObject.AddComponent<NNet>();
            population[i] = new NNet();
        }*/
    ...
    public void SavePopulationToFile() {
        ...
        FileStream file = File.Create("/Users/vieira/Desktop/Teste/Assets/Scripts/best_sensores_frontais.dat");
        bf.Serialize(file, population);
        file.Close();
        saving = false;
    }

    public void LoadPopulationFromFile() {
        string path="/Users/vieira/Desktop/Teste/Assets/Scripts/best_sensores_frontais.dat";
        //population = null;
        if (population == null && File.Exists(path))
        {
            BinaryFormatter bf = new BinaryFormatter();
            FileStream file = File.Open(path, FileMode.Open);
            population = (NNet[])bf.Deserialize(file);
            file.Close();
        }
    }
}
